...
Ventana.setup(width = 600, height = 580)
...
#TEXTO9
texto9 = turtle.Turtle()
texto9.speed(0)
texto9.color('white')
texto9.penup()
texto9.hideturtle()
texto9.goto(0,80)
texto9.write('create by:', align='center', font=('Poppins',15, 'bold'))

#TEXTO55
texto55 = turtle.Turtle()
texto55.speed(0)
texto55.color('gold')
texto55.penup()
texto55.hideturtle()
texto55.goto(0,20)
texto55.write('BELIAL', align='center', font=('Poppins',25, 'bold'))
...
def BtnoClick(x,y): 
       if(x > -73 < 70 and y > -143 and y < -80):
        ...
        Ventana.setup(width=600,height=560)
        Ventana.bgcolor('#FFFFFF')
